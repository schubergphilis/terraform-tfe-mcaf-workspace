...
* fix: terraform tests (#39) @marwinbaumannsbp

**Full Changelog**: https://github.com/schubergphilis/terraform-tfe-mcaf-workspace/compare/v3.0.0...v3.0.1
...
* feat!: Remove deprecated vars trigger_prefixes and workspace_tags (#38) @marwinbaumannsbp

**Full Changelog**: https://github.com/schubergphilis/terraform-tfe-mcaf-workspace/compare/v2.7.1...v3.0.0
...
* fix: clarify VCS-mode trigger behaviour and make trigger logic fully null-safe (#37) @marwinbaumannsbp

**Full Changelog**: https://github.com/schubergphilis/terraform-tfe-mcaf-workspace/compare/v2.7.0...v2.7.1
